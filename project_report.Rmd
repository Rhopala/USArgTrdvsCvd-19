...
We used the data of top 10 U.S. export markets for soybeans, corn, wheat, and cotton (by volume) in each year from 2018 to 2021. Due to the complexity of original data, we only analyzed the largest oversea market of US, China. We calculated the average export volume of China for 2018-2019 and 2020-2021 and made a chart with country as x-axis, export volume as y-axis, and colored by before/after Covid-19. Since the data for top 10 import sources only has import value, doing the same analysis and visualization on this data set, we generated another plot with y-axis of import value. [View Plots](China_import---DB.html)
