...
importvolume_plot = import_volume_df %>% 
  group_by(month,year) %>% 
...
animate(importvolume_plot, duration = 10, renderer = gifski_renderer())
...
From the graph, we are seeing gradually increases of Covid case for both 2020 and 2021.
...
=======
```{r, message=FALSE}
>>>>>>> f69cfbe1a56a80e1907aaee3b9699822f9f3bc7f
