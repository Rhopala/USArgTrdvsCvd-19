...
import_value_df = 
  ...
  mutate(
    product_type = recode(product_type, "Vegetables & preparations" = "Vegetables and preparations","Fruits & preparations" = "	
Fruits and preparations", "Grains & feeds" = "	
Grains and feeds","Beef & veal" = "Beef and veal", "Coffee & products" = "Coffee and products", "Cotton & linters" = "Cotton and linters","Cut flowers & nursery stock" = "Cut flowers and nursery stock","Oilseeds & products" = "Oilseeds and products","Red meats & products" = "Red meats and products", "Sugar & related products" = "Sugar and related products")
  )

export_value_df = 
  read_csv("data/cleaned data/export_value_combined.csv") %>% 
    mutate(
    product_type = recode(product_type,"Cotton & linters" = "Cotton and linters","Red meats & products" = "Red meats and products","Tree nuts & preparations" = "Tree nuts and preparations")
  )
